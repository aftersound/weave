...
class AuthenticationWrapper implements Authentication {
    ...
    private final io.aftersound.weave.service.security.Authentication auth;

    public AuthenticationWrapper(
            AuthenticationControl authenticationControl,
            io.aftersound.weave.service.security.Authentication auth) {
    ...
    public io.aftersound.weave.service.security.Authentication auth() {
        return auth;
    }
