...
import io.aftersound.schema.Typed;
import io.aftersound.schema.TypedField;
...
public interface Record {
    ...
    /**
     * Accept a {@link Func} to process this record and return its processed result
     *
     * @param func - a {@link Func} which takes {@link Record} as input and produce target type
     * @param <T>  - the type of value as processed result of given {@link Func}
     * @return the processed value
     */
    <T> T get(Func<Record, T> func);
}
