 ...
 *
 * @param <T> - generic type of objects being handled
 */
public class Handle<T> {
     ...
     *
     * @param id   - identifier, uniquely identify a handle together with type
     * @param type - type of object to be handled
     * @param <T>  - generic type of object to be handled
     * @return a handle associated with given id and type
     */
     ...
     *
     * @return the object just been detached
     */
