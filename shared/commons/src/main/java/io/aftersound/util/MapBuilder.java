...
public class MapBuilder<K,V> {
    ...
    public MapBuilder<K, V> put(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6) {
        this.map.put(k1, v1);
        this.map.put(k2, v2);
        this.map.put(k3, v3);
        this.map.put(k4, v4);
    ...
    public MapBuilder<K, V> put(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6, V v6, K k7, V v7) {
        this.map.put(k1, v1);
        this.map.put(k2, v2);
        this.map.put(k3, v3);
        this.map.put(k4, v4);
    ...
    public MapBuilder<K, V> putIf(K k, V v, boolean condition) {
        if (condition) {
            this.map.put(k, v);
        }
        return this;
