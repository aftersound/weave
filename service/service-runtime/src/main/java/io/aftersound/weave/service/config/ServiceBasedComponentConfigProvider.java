...
final class ServiceBasedComponentConfigProvider extends ClientAndApplicationAwareConfigProvider<ClientHandle, ComponentConfig> {

    ServiceBasedComponentConfigProvider(
            ClientHandle client,
            String namespace,
            String application,
    ...
    protected List<ComponentConfig> getConfigList() {
        ...
        try {
            ...
            if (response.getStatus() == 200) {
                ...
                return Arrays.asList(configReader.readValue(content, ComponentConfig[].class));
            } else {
                throw new Exception(
                        String.format(
