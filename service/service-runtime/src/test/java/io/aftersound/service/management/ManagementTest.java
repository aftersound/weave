...
import io.aftersound.hikari3x.HikariDataSourceFactory;
import io.aftersound.hikari3x.HikariDatabaseInitializerFactory;
import io.aftersound.hsqldb.HSQLDBFactory;
...
public class ManagementTest {
    ...
    public static void setup() throws Exception {
        MasterFuncFactory.bindInstance(
                MasterFuncFactory.of(CommonFuncFactory.class.getName())
        );
